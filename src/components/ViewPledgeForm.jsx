                ...
                <div className="form-grid">
                    ...
                    <div className="view-fundraiser-action-bar">
                        ...
                        <div className="actions">
                            ...
                            }} disabled={!(pledge.supporter === user?.user_id)}>Update this Pledge
                            </button>
                            <button className="btn negative" type="button" onClick={() => {
                                postDeletePledge(pledge.id).then(() => navigate(`/fundraiser/${pledge.fundraiser}`)).catch((error) => {
                                    setError(error.message);
                                });
                            }} disabled={!(pledge.supporter === user?.user_id)}>Delete this Pledge
                            </button>
                        </div>
                    </div>
                </div>
